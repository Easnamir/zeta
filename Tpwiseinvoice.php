...
$sql1 = "select DISTINCT PO_NO from POPS_DISPATCH_ITEMS where STATUS=2";
			...
			<div class="w3-col l8">
              ...
              <select name="Department" class="w3-select" id="Department">
                  ...
                  ?>
                   ...
                   <div class="w3-col l2 w3-padding-small">
					...
					<div class="w3-col l2 w3-padding-small">
						...
						<button class="w3-button w3-round w3-red tohide" name="submit" type="Submit" id="submit" onclick="tpwiseinvoice()">Submit</button>
                  ...
                  <div class="w3-col l12 w3-border w3-border-black" style="min-height:200px;max-height: 200px;   overflow:auto">
					...
					<thead>
						<tr><th>SNo</th><th>Challan No</th><th>Tp_No</th><th>Department</th><th>Party Name</th><th>case qty</th><th>wsp</th><th>Excise</th><th style="text-align: left !important; padding-left: 10px !important; width: 100px;">  <input type="checkbox" name="checkAllchallan" id="checkAllchallan" value="" onclick="checkAll(this,'tp_inv[]')"/> All</th></tr>	
					</thead>
				...
				<table class="w3-table w3-margin-bottom w3-margin-top" border="1">
					...
					<td style="width: 15%;">
						<button type='button' onclick='processinvoicetp()' class='w3-red w3-button w3-round'>Process</button>
					</td>
				</tr>
			</table>
...
var Submission = document.getElementById('Submission');
   ...
   var Submission=document.getElementById('Submission');
 const tpwiseinvoice = () =>{
			var url = 'invoicedata.php?tpinvoice=tpinvoice&Submission='+Submission.value+'&startdate='+startdate.value+'&enddate='+enddate.value+'&Department='+Department.value;
			 // console.log(url);
