...
<div class="body-content w3-white w3-small">
	<div class="w3-container w3-margin-bottom">
		<div class="w3-row">
			<div class="w3-col">
				<div class="w3-col l6">
					<h3>Challan Reprint</h3>
					</div>
          <div class="w3-col l2">&nbsp;</div>
          <div class="w3-col l4">
           <label for="search">Search Challan</label>
           <input type="text" id="search" class="w3-input w3-border" onkeyup="myFunction()" style="height: 20px;" name="search" placeholder="Search"/>
          </div>
			...
			<div class="w3-col l12" >
				<div class="w3-border w3-border-grey" style="min-height:200px; max-height: 200px;  overflow:auto">
					<table class="w3-table w3-bordered w3-striped w3-card-4" id='challan_list' border="1">
						<thead>
	...
	<script type="text/javascript">
		...
		const print_challanlist_all = () =>{
      debugger;
			var url = 'challandata.php?print_challan_list_all=print_challan_list_all';
			 // console.log(url)
			fetch(url).then(data=>data.text()).then(data=>{
				document.getElementById('show_item11').innerHTML=data;

				// console.log(data);
			})
		}
		print_challanlist_all();
  ...
  table = document.getElementById("challan_list");
