		...
		<div class="w3-row">
			<div class="w3-col">
				<div class="w3-col l8">
					...
					<thead>
						<tr><th>SNo</th><th>DN No</th><th>DN DATE</th><th>Excise Code</th><th>Party Name</th><th>Refrence</th><th>Month</th><th>Total Value </th><th>Narration</th><th>Action</th></tr> 
					</thead>
						<tbody id="printdn_data"  >
								</tbody>
				</table>
				</div>
 ...
 var from_sno=document.getElementById('from_sno');
	 ...
	 if(from_sno.value > to_sno.value){
		...
		return false;
			...
			var url = 'cndn_query.php?printdn=printdn&to_sno='+to_sno.value+'&from_sno='+from_sno.value;
			 // console.log(url);
			fetch(url).then(data=>data.text()).then(data=>{

				// console.log(data);
				document.getElementById('printdn_data').innerHTML=data;
...
const printdninvoice= (id)=>{
         // console.log(id);
         var url = 'print_dn_invoice.php?fun=printInvoicedn&id='+id;
          window.open(url);   
      }
