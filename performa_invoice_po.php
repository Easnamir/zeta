			...
			$tp_num = $_GET['tp_num'];
			   $sql2="select a.*,b.*,c.*,b.gst_no from POPS_PANDING_PO_CREATE a
				...
				while($row2 = sqlsrv_fetch_array($stmt2,SQLSRV_FETCH_ASSOC)){
					...
					$TIN_NO = $row2['TIN'];
          $FSSAI = $row2['FSSAI'];
					$IS_DUTY = ($row2['DUTY_FREE']=='Duty Free');
				}
      //   	print_r($row2);
						// exit;
        ...
        $contact
          ...
          <br><b>GST No : </b> $GST_NO <br><b>FSSAI No :</b> $FSSAI
				...
				<tr><th width=6%>Sno.</th><th colspan=4>Particulars</th><th >Size(ml)</th><th >MRP</th><th>Quantity</th><th>WSP/C</th><th>Excise</th><th width=15%>Amount</th></tr>";
				...
				$html .="<tr><td class='no-top no-right' colspan=6>&nbsp;</td><td class='no-top no-left' align=right colspan=4>Net Payable:<td align=right class='no-top'>".number_format((float)($net_payable), 2, '.', '')."</td></tr>";
...
while($i<11){
				...
				<tr><td colspan=2>
				<table border=1 cellspacing=0 cellpadding=1 width=100%>
				<tr><th width=4%>Sno.</th><th colspan=4 width=36%>Particulars</th><th>Size(ml)</th><th>MRP</th><th>Quantity</th><th>WSP P/B</th><th>Excise </th><th width=10% >Custom Duty</th><th width=13%>Amount</th></tr>";
