...
<div class="body-content w3-white w3-small">
	<div class="w3-container w3-margin-bottom">
		<div class="w3-row">
			<div class="w3-col l9">
					<h3> Lot wise Challan Generation</h3>
					</div>
				...
				<div class="w3-border w3-border-grey" style="min-height: 200px; max-height: 200px;  overflow:auto">
					<table class="w3-table w3-bordered w3-striped w3-border w3-hoverable" border="1">
						<thead>
							<tr><th>SNo</th><th>PO NO</th><th>PO_Date</th><th>Department</th><th>total TP</th><th>Case</th><th>Total</th><th>Excise</th><th style="text-align: left !important; padding-left: 10px !important; width: 100px;">  <input type="checkbox" name="checkAllchallan" id="checkAllchallan" value="" onclick="checkAll(this,'tp_challan[]')"/> All</th></tr>	
						</thead>
						<tbody id="show_item">
						</tbody>
					</table>
				...
				<table class="w3-table w3-margin-bottom" border="1">
					...
					<td style="width: 15%;">
						<button type='button' onclick='processChallan()' class='w3-red w3-button w3-round'>Process</button>
					</td>
				</tr>
			</table>
			</div>
			...
			<form method="POST" name="po_arr_form" id="po_form" action="#">
	...
	startdate.min = getTodaysDate();
		const lotwise_challan = () =>{
			var url = 'challandata.php?lotwise_challan=lotwise_challan';
			 // console.log(url)
...
const processChallan = () =>{
			...
			var url = 'challandata.php?fun=processlotChallan&startdate='+startdate.value;
