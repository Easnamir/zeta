...
<div class="body-content w3-white w3-small">
	<div class="w3-container w3-margin-bottom">
		<div class="w3-row">
			<div class="w3-col">
              ...
              <select name="Department" class="w3-select" id="Department">
						...
						<button class="w3-button w3-round w3-red tohide" name="submit" type="Submit" id="submit" onclick="monthwisereport()">Submit</button>
					...
					<thead>
						<tr><th>SNo</th><th>Department</th><th>Party Code</th><th>Party Name</th><th>Brand Name</th><th>Case</th><th>wsp</th><th>excise</th></tr>	
					</thead>
						<tbody id="monthly"  >
								</tbody>
				</table>
		...
		<div class="w3-center w3-margin-top">
		     <a href="monthlysummary.php" class="w3-red">SUMMARY</a>
		     <a href="monthlydetails.php" class="w3-red">DETAILS</a>
 ...
 var Department=document.getElementById('Department');
	if(Department.value==''){
		...
		return false;
			...
			var url = 'reportdata.php?monthwisereport=monthwisereport&&startdate='+startdate.value+'&enddate='+enddate.value+'&Department='+Department.value;
			 // console.log(url);
			fetch(url).then(data=>data.text()).then(data=>{

				// console.log(data);
				document.getElementById('monthly').innerHTML=data;
