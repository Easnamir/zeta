...
// $data=[];
        ...
        Email: $C_EMAIL, Contact: $C_PHONE</td></tr>
				...
				file_put_contents($inv_no.'.png', $generator->getBarcode($inv_no, $generator::TYPE_CODE_128, 3, 50, $redColor));
	...
	// exit;
				...
				<tr><th width=7%>Sno.</th><th colspan=4 width=40%>Particulars</th><th>Size(ml)</th><th>Case Qty</th><th>MRP</th><th>WSP per/C</th><th width=13%>Amount</th></tr>";
        ...
        $bottles = '';
				...
				for($i=0;$i<$row_count;$i++){
					if($i==15){
						$html .= "</table></td></tr></table><pagebreak><table width=100% border=1><tr><td colspan=2 class='no-bottom'><table id='item_table' border=1 cellspacing=0 cellpadding=1 width=100%>";
					 }
					...
					$amount = number_format($rate*$qty,2,'.','');
					 ...
					 $html .=("<tr><td class='no-top'>".($i+1)."</td><td colspan=4 class='no-top-left'>".$data[$i]['BRAND_NAME']."</td><td class='no-top-left'>".$data[$i]['SIZE_VALUE']."</td><td class='no-top-left'>".$data[$i]['CASE_QUANTITY']." $bottles</td><td class='no-top-left'>".$data[$i]['MRP']."</td><td class='no-top-left'>".$rate."</td><td align=right class='no-top-left'>".$amount."</td><tr>");
				...
				$html .="<tr><td class='only-left' colspan=5>&nbsp;</td><td class='no-border' align=right colspan=4><p><b> Output VAT @25%:</b></p><td align=right class='no-top'><p>".number_format($vat,2,'.','')."</p></td></tr>";
          ...
          $html .="<tr><td class='only-left' colspan=5>&nbsp;</td><td class='no-border' align=right colspan=4><h3>Total Amount:</h3><td align=right class='no-top'><p>".number_format($final_amount, 2, '.', '')."</p></td></tr>";
				...
				// $html .="<tr><td class='no-top no-right' align=left colspan=8><p><b>Amount(in words):</b> ".digit_to_word($net_payable)."</b></p></td><td class='no-top no-right no-left' align=right><h3>Total:</h3><td align=right class='no-top'><p><b>".number_format($net_payable, 2, '.', '')."</b></p></td></tr>";
...
while($i<9){
					...
					$html .="<tr><td colspan=7 class='no-bottom '><p><b>Amount(in words):</b> ".digit_to_word($net_payable)."  Only</b></p></td><td class='no-bottom ' colspan=1> <b>Case Qty:".$sum_quantity."</b></td><td class='no-bottom 'align=right colspan=1><p><b>Total:</b></p></td><td align=right class='no-bottom '><p>".number_format($net_payable,2,'.','')."</p></td></tr>";				
        ...
        </td><td colspan=3 class='text-right' style='border-left: none'>For <b>$COMPANY_NAME</b><br><br><br>Authorised Signatory<br><img src='$inv_no.png' width=150 />&nbsp;&nbsp;&nbsp;</td></tr>";
				$html.="</table></td></tr>";
				
				$html.="</table>";
				$html .="<table border=1 cellspacing=0 cellpadding=1 width=100%><tr><td class='terms' align=left>
        ...
        <tr><td class=' no-border' align=center>This is a computer-generated invoice.</td></tr>
            ...
            $html .="<table border=1 width=100% cellspacing=0 cellpadding=6 style='font-size: 12px'>
				...
				<tr><td colspan=2 class='no-top-bottom'>
				<table id='item_table' border=1 cellspacing=0 cellpadding=1 width=100%>
				<tr><th width=6%>Sno.</th><th width=40% colspan=4>Particulars</th><th>Size(ml)</th><th>Quantity</th><th>MRP</th><th>WSP</th><th width=10%>Duty Paid</th><th width=15%>Amount</th></tr>";
           ...
           $bottles = $pack_size==1?'Btl.':'case';
				...
				$html .="<tr><td class='center only-left' colspan=3><b>Add</td><td class='no-border' align=right colspan=7><p><b>Excise Duty:</b></p><td align=right class='no-top'><p>".number_format($sum_excise,2,'.','')."</p></td></tr>";
          ...
          $html .="<tr><td class='only-left' colspan=5>&nbsp;</td><td class='no-border' align=right colspan=5><h3>Total Amount:</h3><td align=right class='no-top'><p>".number_format($final_amount, 2, '.', '')."</p></td></tr>";
				...
				$html .="<tr><td class='only-left' colspan=3><b> Less </b>&nbsp;</td><td class='no-border' align=right colspan=7><h3>Excise Revenue Received in Advance from Customer:</h3><td align=right class='no-top'><p>".number_format((float) $sum_excise, 2, '.', '')."</p></td></tr>";
				...
				// $html .="<tr><td class='no-top no-right' align=left colspan=9><p><b>Amount(in words):</b>".digit_to_word($net_payable)."</b></p></td><td class='no-top no-right no-left' colspan=1 align=right><h3>Total:</h3><td align=right class='no-top'><p>".number_format($net_payable, 2, '.', '')."</p></td></tr>";
...
while($i<9){
					...
					$html .="<tr><td colspan=8 class='no-bottom '><p><b>Amount(in words):</b> ".digit_to_word($net_payable)."  Only</b></p></td><td class='no-bottom '  colspan=1><b> Total Qty:".$sum_quantity. " </b></td><td class='no-bottom 'align=right colspan=1><p><b>Total:</b></p></td><td align=right class='no-bottom '><p>".number_format($net_payable,2,'.','')."</p></td></tr>";
				$html .="<tr><td colspan=8 align=left style='border-right: none'>
        Received_____________________Cases In Good Order & Condition<br><br>Receiver's Signature___________________
        </td><td colspan=3 class='text-right' style='border-left: none'>For <b>$COMPANY_NAME</b><br><br><br>Authorised Signatory<br><br><br><img src='$inv_no.png' width=150 />&nbsp;&nbsp;&nbsp;</td></tr>";
				$html.="</table></td></tr>";
