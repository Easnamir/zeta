		...
		if(isset($_GET['fun']) && $_GET['fun']=='printInvoicehcr'){
			$tp_num = $_GET['tp_num'];
			  ...
			  $sql2="select a.*,b.*,c.LIQUOR_TYPE_CD from POPS_DISPATCH_ITEMS a
				...
				<tr><th width=6%>Sno.</th><th colspan=4>Particulars</th><th >Size</th><th >MRP</th><th>Quantity</th><th>WSP per
C/s</th><th>Amount</th></tr>";
				...
				<tr><td colspan=2>
				<table border=1 cellspacing=0 cellpadding=1 width=100%>
				<tr><th width=6%>Sno.</th><th colspan=4>Particulars</th><th >Size</th><th >MRP</th><th>Quantity</th><th>WSP</th><th>Custom</th><th>Amount</th></tr>";
