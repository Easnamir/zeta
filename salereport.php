...
<div class="body-content w3-white w3-small">
	<div class="w3-container w3-margin-bottom">
		<div class="w3-row">
			<div class="w3-col">
              ...
              <select name="Department" class="w3-select" id="Department">
						...
						<button class="w3-button w3-round w3-red tohide" name="submit" type="Submit" id="submit" onclick="saleregister()">Submit</button>
					...
					<thead>
						<tr><th>SNo</th><th>Department</th><th>Qty</th><th>WSP</th><th>Excise</th><th>VAT</th><th>TCS</th><th>Total</th></tr>	
					</thead>
						<tbody id="saleregister"  >
								</tbody>
				</table>
				</div>
				</div>
		...
		<div class="w3-center w3-margin-top">
		     ...
		     <a href="salesdetails.php" class="w3-red">DETAILS</a>
 ...
 var Department=document.getElementById('Department');
	if(Department.value==''){
		...
		return false;
			...
			var url = 'reportdata.php?saleregister=saleregister&startdate='+startdate.value+'&enddate='+enddate.value+'&Department='+Department.value;
			//  console.log(url);
			fetch(url).then(data=>data.text()).then(data=>{

				// console.log(data);
				document.getElementById('saleregister').innerHTML=data;
