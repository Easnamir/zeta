...
// $data=[];
	...
	// exit;
				...
				<tr><th width=7%>Sno.</th><th colspan=4>Particulars</th><th>Size(ml)</th><th>Case Qty</th><th>MRP</th><th>WSP per/C</th><th width=13%>Amount</th></tr>";
        ...
        $bottles = '';
				...
				for($i=0;$i<$row_count;$i++){
					// if($i==10){
					// 	$html .= "</table><pagebreak><table id='item_table' border=1 cellspacing=0 cellpadding=1 width=100%>";
					//  }
