                   ...
                   <div class="w3-col l2 w3-padding-small">
					...
					<div class="w3-col l2 w3-padding-small">
					 ...
					 <div class="w3-col l2 w3-padding-small">
						...
						<button class="w3-button w3-round w3-red tohide" name="submit" type="Submit" id="submit" onclick="Master_Data_Report()">Submit</button>
 ...
 var Department=document.getElementById('Department');
	if(Department.value==''){
		...
		return false;
			...
			var url = 'dow_Master_Data_Report.php?dow_Master_Data_Report=dow_Master_Data_Report&startdate='+startdate.value+'&enddate='+enddate.value+'&Department='+Department.value;
